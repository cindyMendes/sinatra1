...
db.execute("INSERT INTO users(email, password) values(?, ?);", ["cindy@example.com", "pass123"])
db.execute("INSERT INTO users(email, password) values(?, ?);", ["piper@example.com", "pass123"])
